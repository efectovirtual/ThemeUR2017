...
function slider_informativo_posttype()
{
    ...
    register_post_type('sliderinformativo', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Slider Informativo', 'html5blank'), // Rename these to suit
            'singular_name' => __('Slider Informativo', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Slider Informativo', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Slider Informativo', 'html5blank'),
            'new_item' => __('New Slider Informativo', 'html5blank'),
            'view' => __('View Slider Informativo', 'html5blank'),
            'view_item' => __('View Slider Informativo', 'html5blank'),
            'search_items' => __('Search Slider Informativo', 'html5blank'),
            'not_found' => __('No Slider Informativo found', 'html5blank'),
            'not_found_in_trash' => __('No Slider Informativo found in Trash', 'html5blank')
        ),
        'public' => true,
        'menu_icon' => 'dashicons-desktop',
        'hierarchical' => false, // Allows your posts to behave like Hierarchy Pages
...
add_action('init','slider_informativo_posttype'); // Slide inicio
